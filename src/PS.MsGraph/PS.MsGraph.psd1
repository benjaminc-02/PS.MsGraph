#
# Module manifest for module 'PS.MsGraph'
#
...
@{
    ...
    GUID              = '62a1e741-0dac-49fa-ac7f-3e484f5c0c2d'
    ...
    FunctionsToExport = @(
        ...
        'Get-MsGApplicationPassword',
        'Get-MsGDirectoryObject',
        'Get-MsGDirectoryObjectMemberOf',
        'Get-MsGDirectoryRoleAssignment',
